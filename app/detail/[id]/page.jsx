      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-8">
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-500">({Math.floor(project.rating * 3.4)})</span>
                  </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-[#004A74]">Anggota Kelompok</h2>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <p className="font-semibold text-[#004A74]">{comment.author}</p>
                          ...
                          <div key={reply.id} className="flex gap-3">
                            ...
                            <div className="flex-1">
                              <div className="flex items-start justify-between mb-1">
                                <p className="font-semibold text-[#004A74] text-sm">{reply.author}</p>
